...
function middleware(request) {
    ...
    if (hostname === 'fun.colincassell.com') {
        // let static assets and next internals through unchanged
        if (pathname.startsWith('/fun/') || pathname.startsWith('/_next/') || pathname.includes('.') // files with extensions
        ) {
    ...
    if (pathname === '/chillin-out') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL('/404', request.url));
    }
